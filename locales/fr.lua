Locales['fr'] = {
  ...
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~families~s~',
  -- Vehicle interaction
  ...
  ['traffic_offense'] = 'Petit rackette',
  ['minor_offense'] = 'Moyen rackette',
  ['average_offense'] = 'Grand rackette',
  ['major_offense'] = 'Enorme rackette',
  ['fine_total'] = 'amende: %s',
  -- Vehicle Info Menu
  ['plate'] = 'n°: %s',
  ...
  ['families_stock'] = 'coffre de la families',
  -- Misc
  ...
  -- Notifications
  ['alert_families'] = 'alerte families',
  ['phone_families'] = 'families',
}
